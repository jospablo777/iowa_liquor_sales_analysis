# ==================================================================
# Modified this script from the original work of 
# Koundinya Desiraju, you can find his wonderful work in the repo:
# https://github.com/koundy/ggplot_theme_Publication/tree/master
#
# Koundinya also authored an article in Medium about this:
...
theme_Publication <- function(base_size=14, base_family="sans") {
      ...
      (theme_foundation(base_size=base_size, base_family=base_family)
       + theme(plot.title = element_text(face = "bold",
               ...
               axis.line.x = element_line(colour="#8d8d8d"),
               axis.line.y = element_line(colour="#8d8d8d"),
...
theme_dark_blue <- function(base_size=14, base_family="sans") {
   ...
   (theme_foundation(base_size=base_size, base_family=base_family)
      + theme(plot.title = element_text(face = "bold", colour = '#ffffb3',
                                        size = rel(1.2), hjust = 0.5, margin = margin(0,0,20,0)),
              text = element_text(),
              panel.background = element_rect(colour = NA, fill = '#282b30'),
              plot.background = element_rect(colour = NA, fill = '#282b30'),
              panel.border = element_rect(colour = NA),
              axis.title = element_text(face = "bold",size = rel(1), colour = 'white'),
              axis.title.y = element_text(angle=90,vjust =2),
              axis.title.x = element_text(vjust = -0.2),
              ...
              panel.grid.minor = element_blank(),
              legend.background = element_rect(fill ='#282b30'),
              legend.text = element_text(color = 'white'),
              legend.key = element_rect(colour = NA, fill = '#282b30'),
              legend.position = "bottom",
              legend.direction = "horizontal",
              legend.box = "vetical",
              legend.key.size= unit(0.5, "cm"),
